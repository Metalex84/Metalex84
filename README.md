...
*   **[Minitalk & C Infrastructure](https://github.com/Metalex84/Minitalk) (C / Unix):** Desarrollo de bajo nivel realizado durante el Cursus de **42 - The Network**. Incluye la implementación de un protocolo de comunicación de baja latencia mediante señales UNIX, manipulación de memoria y librerías del sistema estándar (`libft`, `printf`).
*   **[QR Generator](https://github.com/Metalex84/qr_generate) (Python, Flask):** Microservicio web para la generación y renderizado dinámico de datos estructurados en formatos visuales.
*   **[Android Booklist App](https://github.com/Metalex84/AndroidBooklist) (Kotlin, Room, GSON):** Aplicación móvil con persistencia relacional local y serialización de datos estructurados para optimización de memoria.
